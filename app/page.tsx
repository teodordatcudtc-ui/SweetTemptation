...
export default function Home() {
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-cream via-cream to-cream/95 pt-8 md:pt-20">
        {/* Floating Pastries */}
        <FloatingPastry
        ...
        {/* Decorative Elements */}
        <div className="hidden md:block absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-cream to-transparent" />
      </section>
